...
int main(int argc, char** argv)
{
    ...
    int iter = 150;
    //VideoWriter vid("CC_IterThres_Aquarium.avi",CV_FOURCC('D','I','V','X'),20,Size(1636,1236),true);
    ...
    for (int i=0; i < iter; i++) {
        ...
        img1 = imread(file1,1);
        img2 = imread(file2,1);
        //img1 = imread("./CS585-AquariumImages/aquarium_frame000000009.ppm.png",1);
        //img2 = imread("./CS585-AquariumImages/aquarium_frame000000039.ppm.png",1);
        ...
        calcHist(&out_v, 1, 0, Mat(), hist_v, 1, &histSize, &histRange, uniform, accumulate);
        ...
        double thr = threshold(out_v, th1, thresh, max_thresh, THRESH_BINARY);
        Mat sub_th1;
        ...
        color_th1.create(sub_th1.rows,sub_th1.cols, CV_8UC3);
        color_regions(sub_th1,color_th1);
