...
int fr_number=0;
ofstream output_file2("statistics_cells.csv");
...
int main(int argc, char** argv)
{
    ...
    //int iter = 5;
    //VideoWriter vid("Segment_Cells.avi",CV_FOURCC('D','I','V','X'),5,Size(1300,1030),true);
    //VideoWriter vid2("cell_orig.avi",CV_FOURCC('D','I','V','X'),5,Size(1300,1030),true);
    ...
    for (int i=0; i < iter; i++) {
        ...
        dilate(adap_img1,adap_img1,Mat(),Point(-1,-1),15);
        erode(adap_img1,adap_img1,Mat(),Point(-1,-1),12);


        getStats(adap_img1);
        //imshow("Adap", adap_img1);

        color_th1.create(adap_img1.rows,adap_img1.cols, CV_8UC3);
        color_regions(adap_img1,color_th1);

        imshow("Connected Components",color_th1);
        //imshow("Connected Components",temp1);
        //vid.write(color_th1);
        //vid2.write(img);
        //vid.write(adap_img1);
