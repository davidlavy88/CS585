...
int main()
{
    String filename_seg = "Segmentation_Bats/CS585Bats-Segmentation_frame000000752.txt";
	Mat labelled, binary;
	convertFileToMat(filename_seg, labelled, binary);

    String filename_det = "Localization_Bats/CS585Bats-Localization_frame000000752.txt";
	Mat binary3C;
